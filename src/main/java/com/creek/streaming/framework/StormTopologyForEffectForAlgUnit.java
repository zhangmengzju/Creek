...
import com.creek.streaming.framework.producer.effect.algUnit.BoltForEffect;
import com.creek.streaming.framework.source.SpoutInstance;
import com.creek.streaming.framework.utils.StreamFileUtils;

public class StormTopologyForEffectForAlgUnit {
    //////Log
    private static final Logger           LOGGER   = LoggerFactory.getLogger(StormTopologyForEffectForAlgUnit.class);
    ...
    public static TopologyBuilder initTopology(String topoConfPath) throws IOException, ClassNotFoundException, InstantiationException, IllegalAccessException {
        try {
            ...
            topoProp.load(StormTopologyForEffectForAlgUnit.class.getResourceAsStream(topoConfPath));
        } catch (IOException e) {
        ...
        for (int i = 1; i <= spoutInstanceNum; i++) {
            ...
            if (type.equals("tt")) {
                ...
                //TT -> Spout
                File tempFile = StreamFileUtils.stream2file(StormTopologyForEffectForAlgUnit.class
